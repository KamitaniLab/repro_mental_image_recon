        ...
        for i, r_img in enumerate(recon_image_pil_list):
            ...
            for j, t_img in enumerate(target_image_pil_list):
                ...
                similarity = np.corrcoef(
                    recon_image_array.flatten(), cand_image_array.flatten()
                )[0, 1]
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            "SGLDOnly_middle",
            "VGGonly_middle",
            "8_reconstruct_imagined_image_withDGN_19_layer_conv2_fc6",
        ],
    )

    # parser.add_argument('--eval_model', type=str, default="alexnet")
    parser.add_argument(
        "--loss_name", type=str, default="correlation", choices=["correlation", "MSE"]
    )
